    ...
    <Row>
      <Col md="8">
        <h2 data-cy="cartDetailsHeading">
          <Translate contentKey="ivyModaApp.cart.detail.title">Cart</Translate>
        </h2>
        <dl className="jh-entity-details">
          ...
          <dd>{cartEntity.createAt ? <TextFormat value={cartEntity.createAt} type="date" format={APP_DATE_FORMAT} /> : null}</dd>
          <dt>
            <Translate contentKey="ivyModaApp.cart.user">User</Translate>
          </dt>

    ...
    <Row>
      <Col md="8">
        <h2 data-cy="orderItemDetailsHeading">
          <Translate contentKey="ivyModaApp.orderItem.detail.title">OrderItem</Translate>
        </h2>
        <dl className="jh-entity-details">
          ...
          <dt>
            <Translate contentKey="ivyModaApp.orderItem.productVariant">Product Variant</Translate>
          </dt>
          <dd>{orderItemEntity.productVariant ? orderItemEntity.productVariant.id : ''}</dd>
          <dt>
            <Translate contentKey="ivyModaApp.orderItem.order">Order</Translate>
          </dt>

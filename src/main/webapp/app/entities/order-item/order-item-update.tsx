  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="ivyModaApp.orderItem.home.createOrEditLabel" data-cy="OrderItemCreateUpdateHeading">
            <Translate contentKey="ivyModaApp.orderItem.home.createOrEditLabel">Create or edit a OrderItem</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('ivyModaApp.orderItem.quantity')}
              ...
              />
              <ValidatedField
                label={translate('ivyModaApp.orderItem.price')}
                id="order-item-price"
                name="price"
                data-cy="price"
                type="text"
              ...
              <ValidatedField
                ...
                label={translate('ivyModaApp.orderItem.productVariant')}
                type="select"
              >
                <option value="" key="0" />
                {productVariants
              ...
              <ValidatedField
                ...
                name="order"
                data-cy="order"
                label={translate('ivyModaApp.orderItem.order')}
                type="select"
              >
                <option value="" key="0" />
                {orders

    ...
    <Row>
      <Col md="8">
        <h2 data-cy="cartItemDetailsHeading">
          <Translate contentKey="ivyModaApp.cartItem.detail.title">CartItem</Translate>
        </h2>
        <dl className="jh-entity-details">
          ...
          <dt>
            <Translate contentKey="ivyModaApp.cartItem.productVariant">Product Variant</Translate>
          </dt>
          <dd>{cartItemEntity.productVariant ? cartItemEntity.productVariant.id : ''}</dd>
          <dt>
            <Translate contentKey="ivyModaApp.cartItem.cart">Cart</Translate>
          </dt>

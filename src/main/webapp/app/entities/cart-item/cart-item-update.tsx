...
export const CartItemUpdate = () => {
  ...
  const defaultValues = () =>
    isNew
      ...
      : {
          ...cartItemEntity,
          productVariant: cartItemEntity?.productVariant?.id,
  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="ivyModaApp.cartItem.home.createOrEditLabel" data-cy="CartItemCreateUpdateHeading">
            <Translate contentKey="ivyModaApp.cartItem.home.createOrEditLabel">Create or edit a CartItem</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('ivyModaApp.cartItem.quantity')}
              ...
              />
              <ValidatedField
                id="cart-item-productVariant"
                name="productVariant"
                data-cy="productVariant"
                label={translate('ivyModaApp.cartItem.productVariant')}
                type="select"
              >
                <option value="" key="0" />
                {productVariants
              ...
              <ValidatedField id="cart-item-cart" name="cart" data-cy="cart" label={translate('ivyModaApp.cartItem.cart')} type="select">
                <option value="" key="0" />
                {carts

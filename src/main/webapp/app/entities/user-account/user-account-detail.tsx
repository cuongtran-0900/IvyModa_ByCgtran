    ...
    <Row>
      <Col md="8">
        <h2 data-cy="userAccountDetailsHeading">
          <Translate contentKey="ivyModaApp.userAccount.detail.title">UserAccount</Translate>
        </h2>
        <dl className="jh-entity-details">
          ...
          <dt>
            <Translate contentKey="ivyModaApp.userAccount.role">Role</Translate>
          </dt>
          <dd>{userAccountEntity.role ? userAccountEntity.role.id : ''}</dd>
        </dl>

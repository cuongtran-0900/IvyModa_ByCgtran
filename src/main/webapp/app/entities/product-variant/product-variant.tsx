  ...
  return (
    <div>
      <h2 id="product-variant-heading" data-cy="ProductVariantHeading">
        <Translate contentKey="ivyModaApp.productVariant.home.title">Product Variants</Translate>
        <div className="d-flex justify-content-end">
          <Button className="me-2" color="info" onClick={handleSyncList} disabled={loading}>
            <FontAwesomeIcon icon="sync" spin={loading} />{' '}
            <Translate contentKey="ivyModaApp.productVariant.home.refreshListLabel">Refresh List</Translate>
          </Button>
          <Link to="/product-variant/new" className="btn btn-primary jh-create-entity" id="jh-create-entity" data-cy="entityCreateButton">
            ...
            &nbsp;
            <Translate contentKey="ivyModaApp.productVariant.home.createLabel">Create new Product Variant</Translate>
          </Link>
        </div>
      </h2>
        ...
        {productVariantList && productVariantList.length > 0 ? (
            ...
            <thead>
              <tr>
                <th className="hand" onClick={sort('id')}>
                  <Translate contentKey="ivyModaApp.productVariant.id">ID</Translate>{' '}
                ...
                <th>
                  <Translate contentKey="ivyModaApp.productVariant.product">Product</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th />
              </tr>
            </thead>
            <tbody>
              {productVariantList.map((productVariant, i) => (
                <tr key={`entity-${i}`} data-cy="entityTable">
                  ...
                  <td>{productVariant.isActive ? 'true' : 'false'}</td>
                  <td>
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="ivyModaApp.productVariant.home.notFound">No Product Variants found</Translate>
            </div>
          )
        )}
      </div>

...
export const ProductVariantDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="ivyModaApp.productVariant.delete.question">
        <Translate contentKey="ivyModaApp.productVariant.delete.question" interpolate={{ id: productVariantEntity.id }}>

...
/**
 * REST controller for managing {@link ivymoda.domain.UserAccount}.
 */
@RestController
...
public class UserAccountResource {
    ...
    public ResponseEntity<List<UserAccountDTO>> getAllUserAccounts(
        ...
        if ("cart-is-null".equals(filter)) {
            LOG.debug("REST request to get all UserAccounts where cart is null");
            return new ResponseEntity<>(userAccountService.findAllWhereCartIsNull(), HttpStatus.OK);
        }

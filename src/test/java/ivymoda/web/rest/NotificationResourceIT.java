...
import static ivymoda.domain.NotificationAsserts.*;
...
import ivymoda.repository.NotificationRepository;
import ivymoda.service.dto.NotificationDTO;
import ivymoda.service.mapper.NotificationMapper;
...
class NotificationResourceIT {
    ...
    public static Notification createEntity() {
        return new Notification().type(DEFAULT_TYPE).content(DEFAULT_CONTENT).createAt(DEFAULT_CREATE_AT).isRead(DEFAULT_IS_READ);
    }
    ...
    public static Notification createUpdatedEntity() {
        return new Notification().type(UPDATED_TYPE).content(UPDATED_CONTENT).createAt(UPDATED_CREATE_AT).isRead(UPDATED_IS_READ);
    }
    ...
    void putExistingNotification() throws Exception {
        ...
        updatedNotification.type(UPDATED_TYPE).content(UPDATED_CONTENT).createAt(UPDATED_CREATE_AT).isRead(UPDATED_IS_READ);
    ...
    void partialUpdateNotificationWithPatch() throws Exception {
        ...
        partialUpdatedNotification.content(UPDATED_CONTENT).createAt(UPDATED_CREATE_AT);
    ...
    void fullUpdateNotificationWithPatch() throws Exception {
        ...
        partialUpdatedNotification.type(UPDATED_TYPE).content(UPDATED_CONTENT).createAt(UPDATED_CREATE_AT).isRead(UPDATED_IS_READ);

...
import static ivymoda.domain.ProductAsserts.*;
...
import ivymoda.repository.ProductRepository;
import ivymoda.service.dto.ProductDTO;
import ivymoda.service.mapper.ProductMapper;
...
class ProductResourceIT {
    ...
    void partialUpdateProductWithPatch() throws Exception {
        ...
        partialUpdatedProduct.slug(UPDATED_SLUG).introduce(UPDATED_INTRODUCE).createAt(UPDATED_CREATE_AT).isActive(UPDATED_IS_ACTIVE);
